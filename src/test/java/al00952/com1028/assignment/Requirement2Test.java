...
public class Requirement2Test {
	...
	@Test
	public void paymentDAOTest() throws ParseException {
		int i = 0;
		PaymentDAO paymentDAO = new PaymentDAO();
		// We compare the first few ordered Dates
		ArrayList<Date> expectedDateValues = new ArrayList<Date>(Arrays.asList(this.dateConversion("2003-01-16"), this.dateConversion("2003-01-28"), this.dateConversion("2003-01-30"), this.dateConversion("2003-02-16"), this.dateConversion("2003-02-20"), this.dateConversion("2003-02-25"), this.dateConversion("2003-03-02"), this.dateConversion("2003-03-09"), this.dateConversion("2003-03-12"), this.dateConversion("2003-03-20"), this.dateConversion("2003-03-27"))); 
				
		for (Payments payment : paymentDAO.sortAllPaymentsbyDate()) {
			assertEquals(expectedDateValues.get(i),payment.getPaymentDate()); 
			i++;
	...
	@Test
	public void paymentDAOPrintTest() {
		PaymentDAO paymentDAO = new PaymentDAO();
		...
		assertEquals("Date: 2003-01-16   CustomerNumber:  363   Amount:    10223.83   CheckNumber:  IS232033\r\n" + 
				...
				"", paymentDAO.getTotalPaymentsbyDate());
	}
}
